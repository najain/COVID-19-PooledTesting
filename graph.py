...
if __name__ == "__main__":
	...
	if args.plot:
		if not os.path.exists(LOAD_DIR):
			...
			myLog("Median Infected: " + str(np.median(simsInfected)), True)
			myLog("Median Isolated: " + str(np.median(simsIsolated)), True)
			myLog("Median Healthy Non-Isolated: " + str(np.median(simsHealthyFree)), True)
			myLog("Median Infected Non-Isolated: " + str(np.median(simsSickFree)), True)
			myLog("Median Infected Isolated: " + str(np.median(simsSickIsolated)), True)
			myLog("Median Healthy Isolated: " + str(np.median(simsHealthyIsolated)), True)
