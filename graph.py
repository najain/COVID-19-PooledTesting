...
if __name__ == "__main__":
	...
	if args.plot:
		if not os.path.exists(LOAD_DIR):
			...
			totalPop = simsHealthyIsolated[0]+ simsSickIsolated[0] + simsHealthyFree[0] + simsSickFree[0]
			print("Population: " + str(totalPop))
			myLog("Median Infected: " + str(np.median(simsInfected)/totalPop *100), True)
			myLog("Median Isolated: " + str(np.median(simsIsolated)/totalPop *100), True)
			myLog("Median Healthy Non-Isolated: " + str(np.median(simsHealthyFree)/totalPop *100), True)
			myLog("Median Infected Non-Isolated: " + str(np.median(simsSickFree)/totalPop *100), True)
			myLog("Median Infected Isolated: " + str(np.median(simsSickIsolated)/totalPop *100), True)
			myLog("Median Healthy Isolated: " + str(np.median(simsHealthyIsolated)/totalPop *100), True)
